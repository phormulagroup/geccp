...
import { Button, Col, Row, Modal, Form, Input, Select, Radio, Checkbox, Divider, InputNumber, DatePicker, Steps } from "antd";

import helpers from "../../../utils/helpers";
import dayjs from "dayjs";
import { AiFillPlusCircle, AiOutlineDelete, AiOutlinePlayCircle, AiOutlinePlus, AiOutlinePlusCircle } from "react-icons/ai";
...
import CharlsonIndex from "../../../components/charlsonIndex";
      ...
      {!type && (
        <div className="bg-[#17A38D] p-6 grid grid-cols-3 gap-4 items-center mt-4 rounded-[5px]">
          <div className="flex flex-col">
            ...
            <img className="mt-4 max-w-[150px]" src={imgImportCSV} />
          </div>
        ...
        <div className="flex-col justify-center items-center w-full mt-6">
          <div className="grid grid-cols-3">
            ...
            <div className="flex flex-col justify-center items-center">
              ...
              <p className="text-black font-bold text-[20px]">Dados demográficos e estilo de vida</p>
            </div>
            <div className="flex flex-col justify-center items-end">
              <Button size="large" type="primary" className="rounded-full!" icon={<AiOutlinePlayCircle />} onClick={() => setType("step")}>
                Nova submissão
              </Button>
            </div>
          </div>
          <Form form={form} onFinish={submitForm} layout="vertical">
            <div className="border-dashed border-[2px] border-[#8BD1C6] p-12 rounded-[10px] grid grid-cols-3 gap-12 mt-6">
              ...
              <div className="col-span-2 border-dashed border-[2px] border-[#8BD1C6] p-6 grid grid-cols-3 gap-x-12 gap-y-4 items-center mt-4 rounded-[10px]">
                ...
                <Form.Item noStyle shouldUpdate={(prevValues, currentValues) => prevValues.smoking_habits !== currentValues.smoking_habits}>
                  {({ getFieldValue }) =>
                    (getFieldValue("smoking_habits") === "Fumador ativo" || getFieldValue("smoking_habits") === "Ex-fumador") && (
                      <>
                        <div className="col-span-3">
                          <Divider className="mt-0! mb-0! h-[4px] bg-[#17A38D]" />
                        </div>
                        <div className="mt-4">
              ...
              <div className="col-span-2 border-dashed border-[2px] border-[#8BD1C6] p-6 grid grid-cols-2 gap-x-0 gap-y-4 mt-4 rounded-[10px]">
                ...
                >
                  {({ getFieldValue }) =>
                    ...
                    getFieldValue("alcohol_six_or_more") >= 0 && (
                      <div className="flex flex-col p-6 bg-[#8BD1C6] col-span-2 justify-center items-center rounded-b-[5px] mt-4">
              ...
              <Form.List name="other_consumption">
                {(fields, { add, remove, move }) => (
                  <div>
                    <p className="label mb-[8px]">Outros consumos</p>
                    {fields.map((field) => (
              ...
              <div>
                <Form.List name="comorbidities">
                  {(fields, { add, remove, move }) => (
                    <div>
                      <p className="label mb-[8px]">Comorbilidades</p>
                      {fields.map((field) => (
                        <div className="flex flex-col">
                          <div className="flex flex-nowrap mt-4">
                              ...
                              <Form.Item noStyle shouldUpdate={(prevValues, currentValues) => prevValues.comorbidities !== currentValues.comorbidities}>
                                {({ getFieldValue }) =>
                                  getFieldValue("comorbidities")[field.name]?.name === "Doença autoimune" && (
                                    <div>
                                      <Form.Item name={[field.name, "specidfied"]} className="mb-[12px]! mt-[12px]!">
              ...
              <div className="flex flex-col w-full">
                <div className="border-dashed border-[2px] border-[#8BD1C6] p-6 rounded-[10px]">
