...
export default function PalliativeTreatment({ form, next, previous }) {
  return (
    <div className="border-dashed border-2 border-[#8BD1C6] p-6 rounded-[10px] grid grid-cols-4 gap-x-12 gap-y-4 mt-4">
      ...
      <Form.List name="palliative_treatment_lines">
                  ...
                  >
                    {({ getFieldValue }) => (
                      <>
                        <div
                          className={`${
                            getFieldValue("palliative_treatment_lines")[field.name]?.symptoms === "Sintomas"
                              ? "col-span-2 border-r-2  border-dashed border-[#8BD1C6]"
                              : "col-span-4"
                ...
                <div className="col-span-4">
                  <div className="grid grid-cols-3 gap-4">
                    ...
                    <div>
                      ...
                      >
                        {({ getFieldValue }) =>
                          getFieldValue("palliative_treatment_lines")[field.name]?.serious_adverse_events_adjust_discontinuation === "Outro" && (
