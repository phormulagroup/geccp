    ...
    <div className="border-dashed border-2 border-[#8BD1C6] p-6 rounded-[10px] grid grid-cols-4 gap-x-12 gap-y-4 mt-4">
      ...
      <div className="col-span-4">
        <div className="flex justify-between items-center">
          <Form.Item name="palliative_treatment_lines" layout="horizontal" className="mb-0!">
                ...
                <>
                  ...
                  <div className="col-span-2">
                    <Form.Item name={[field.name, "palliative_treatment_reason"]} className="mb-0!">
                      <Radio.Group className="flex w-full!" size="large">
                        <Radio value="Doente considerado pela equipa médica unfit para tratamento radical">
                          Doente considerado pela equipa médica unfit para tratamento radical
                        </Radio>
                  ...
                  <div className="col-span-4 mt-4">
                    <div className="grid grid-cols-3 gap-4">
                      <div>
                        ...
                        <Form.Item name={[field.name, "diagnostic_date"]} className="mb-0!">
                          <DatePicker size="large" className="w-full" />
                        </Form.Item>
                      </div>
                    </div>
                                  ...
                                  <div>
                                    {fieldsTreatmentAdjustmentDiscontinuation.map((fieldTreatmentAdjustmentDiscontinuation) => (
                                      <div className="border-2 border-dashed border-[#8BD1C6] p-4 rounded-[10px] mt-4 mb-6 relative">
                                        <p className="pb-2 text-[12px]">Fármaco(s) que foi(oram) suspenso(s):</p>
                                        <Form.Item
                                          name={[fieldTreatmentAdjustmentDiscontinuation.name, "need_treatment_adjustment_discontinuation_drugs"]}
                                          className="mb-0! w-full!"
                                        >
                                          <Input size="large" className="w-full!" />
                                        </Form.Item>
                                        <p className="pb-2 text-[12px] mt-4">Período de suspensão temporária:</p>
                                        <Form.Item
                                          name={[fieldTreatmentAdjustmentDiscontinuation.name, "need_treatment_adjustment_discontinuation_days"]}
                                          className="mb-0! w-full!"
                                        >
                                          <InputNumber size="large" className="w-full!" suffix="Dias" />
                                        </Form.Item>
                            ...
                            {fieldsTimeAdministration.map((fieldTimeAdministration) => (
                              <>
                                <div>
                                  ...
                                  <Form.Item name={[fieldTimeAdministration.name, "date"]} className="mb-0! w-full!">
                                    <DatePicker size="large" className="w-full!" />
                                  </Form.Item>
                                </div>
                                <div>
                  ...
                  <div className="col-span-4 mt-4">
                    <div className="grid grid-cols-3 gap-4">
                      <div>
                        <p className="font-bold pb-2">Data do diagnóstico:</p>
                        <Form.Item name={[field.name, "serious_adverse_events_immunotherapy_date"]} className="mb-0!">
                          <DatePicker size="large" className="w-full" />
                        </Form.Item>
                      </div>
                    </div>
                    ...
                    {({ getFieldValue }) =>
                      getFieldValue("palliative_treatment")[field.name]?.treatment_line_ongoing === "Não" && (
                        <>
                          ...
                          <div className="col-span-4">
                            <div className="grid grid-cols-3 gap-4">
                              <Form.Item name={[field.name, "best_imagiologic_response_date"]}>
                                <DatePicker className="w-full" />
                              </Form.Item>
                            </div>
                          </div>
                        ...
                        getFieldValue("palliative_treatment")[field.name]?.palliative_care_referral === "Sim" && (
                          <div className="grid grid-cols-3 gap-4">
                            <div>
                              ...
                              <Form.Item name={[field.name, "palliative_care_referral_date"]} className="mb-0!" layout="horizontal">
                                <DatePicker className="w-full" />
                              </Form.Item>
                            </div>
                          </div>
                        ...
                        getFieldValue("palliative_treatment")[field.name]?.diagnosis_metachronous_tumor === "Sim" && (
                          <div className="grid grid-cols-3 gap-4">
                            ...
                            <div>
                              ...
                              <Form.Item name={[field.name, "diagnosis_metachronous_tumor_date"]} className="mb-0!" layout="horizontal">
                                <DatePicker className="w-full" />
                              </Form.Item>
                            </div>
                          </div>
                        ...
                        getFieldValue("palliative_treatment")[field.name]?.death === "Sim" && (
                          <div className="grid grid-cols-3 gap-4">
                            <div>
                              ...
                              <Form.Item name={[field.name, "death_date"]} className="mb-0!" layout="horizontal">
                                <DatePicker className="w-full" />
                              </Form.Item>
                            </div>
                            <div className="col-span-2">
